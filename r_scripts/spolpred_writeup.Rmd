...
# Get geo numbers
n_samps_geo <- data.frame(as.list(sort(rowSums(select(region_family_tab, -Region) ), decreasing = T) ))
...
unknown_geo_pc <- pmt_pc(n_samps_geo$Unknown/n_total_samps_before_filter)
