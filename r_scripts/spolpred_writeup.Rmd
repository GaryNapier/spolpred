...
**Conclusions:** We present a faster more streamlined software for predicting spoligotypes *in silico* from WGS. Soligotypes are usefully predictive of lineage at the first two hierarchical lineage levels, but nevertheless retain important phylogeographical information, leading to the recomendation that both systems should be used in tandem.
